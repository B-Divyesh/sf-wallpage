# Wallpage: a browser 'screensaver' gallery of evolving generative scenes for TVs, second monitors and wall displays (`wallpage`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://wallpage.sociobot.in`. Artifact class: `static-web`.
