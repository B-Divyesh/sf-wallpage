...
export const scenes: SceneDefinition[] = [
  ...
  { id: 'quiet-duel', index: '03', title: 'Quiet duel', description: 'Two fields meet and shift slowly along a soft frontier.' },
  { id: 'cloud-chamber', index: '04', title: 'Cloud chamber', description: 'Storm vapor gathers, opens, and dissolves in slow layers.' },
  ...
  { id: 'fault-garden', index: '09', title: 'Fault garden', description: '$19 Collector scene — geological cells move along illuminated seams.', collector: true },
  { id: 'aurora-basin', index: '10', title: 'Aurora basin', description: '$19 Collector scene — bands of mineral light fold over a black horizon.', collector: true },
];
